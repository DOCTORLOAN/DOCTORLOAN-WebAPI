...
[AttributeUsage(AttributeTargets.Class | AttributeTargets.Method)]public class AuthorizeActionFilter : Attribute, IAuthorizationFilter
{    
    private readonly PermissionModuleEnum _module;   
    private readonly PermissionActionEnum _action;   
    private readonly IApplicationDbContext _context;   
    private readonly ICurrentUserService _currentUserService;   
    public AuthorizeActionFilter(PermissionModuleEnum module, PermissionActionEnum action        , IApplicationDbContext context, ICurrentUserService currentUserService)   
    {       
        _module = module;     
        _action = action;      
        _context = context;      
