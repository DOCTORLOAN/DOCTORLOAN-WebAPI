...
namespace DoctorLoan.Application.Common.Extentions;public static class DataExtensions
{    
    ...
    {      
        return (userAddress != null ? string.Join(", ", new List<string> 
        { 
            userAddress.Address.AddressLine, 
            $"{userAddress.Address.Ward.Type} {userAddress.Address.Ward.Name}", 
            $"{userAddress.Address.District.Type} {userAddress.Address.District.Name}", 
            $"{userAddress.Address.Province.Type} {userAddress.Address.Province.Name}", 
            userAddress.Address.Country.Name 
        }) : null);   
    }   
