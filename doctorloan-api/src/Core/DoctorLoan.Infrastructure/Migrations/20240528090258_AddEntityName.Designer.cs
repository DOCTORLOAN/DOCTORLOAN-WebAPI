...
namespace DoctorLoan.Infrastructure.Migrations
{
    ...
    [Migration("20240528090258_AddEntityName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MedicalRecordMedia");
                });

            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordsCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MedicalRecordsCategory");
                });

            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordsCategoryMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MedicalRecordsCategoryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MedicalRecordsCategoryId");

                    b.ToTable("MedicalRecordsCategoryMapping");
                });

            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordsSymptoms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MedicalRecordsSymptoms");
                });

            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.SymptomGroups", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SymptomGroups");
                });

            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.Symptoms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecord", b =>
                {
                    b.HasOne("DoctorLoan.Domain.Entities.Customers.Customer", "Customers")
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordMedia", b =>
                {
                    ...
                    b.HasOne("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecord", "MedicalRecord")
                        .WithMany("MedicalRecordMedias")
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordsCategoryMapping", b =>
                {
                    b.HasOne("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecord", "MedicalRecord")
                        .WithMany("MedicalRecordsCategoryMapping")
                        .HasForeignKey("MedicalRecordId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordsCategory", "MedicalRecordsCategory")
                        .WithMany("MedicalRecordsCategoryMappings")
                        .HasForeignKey("MedicalRecordsCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("MedicalRecord");

                    b.Navigation("MedicalRecordsCategory");
                });

            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordsSymptoms", b =>
                {
                    b.HasOne("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecord", "MedicalRecord")
                        .WithMany("MedicalRecordsSymptoms")
                        .HasForeignKey("MedicalRecordId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DoctorLoan.Domain.Entities.MedicalRecord.Symptoms", "Symptom")
                        .WithMany()
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.Symptoms", b =>
                {
                    b.HasOne("DoctorLoan.Domain.Entities.MedicalRecord.SymptomGroups", "SymptomGroup")
                        .WithMany("Symptoms")
                        .HasForeignKey("SymptomGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SymptomGroup");
                });
            ...
            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecord", b =>
                {
                    b.Navigation("MedicalRecordMedias");

                    b.Navigation("MedicalRecordsCategoryMapping");

                    b.Navigation("MedicalRecordsSymptoms");
                });

            modelBuilder.Entity("DoctorLoan.Domain.Entities.MedicalRecord.MedicalRecordsCategory", b =>
                {
                    b.Navigation("MedicalRecordsCategoryMappings");
                });
