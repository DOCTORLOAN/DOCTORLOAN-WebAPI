...
#region User  
    ...
    public const string BankBranchId = "BankBranchId";  
    ...
    public const string ImageFront = "ImageFront";   
    public const string ImageBack = "ImageBack";  
...
#region Document  
    ...
    public const string DocumentType = "DcoumentType"; 
#endregion  
